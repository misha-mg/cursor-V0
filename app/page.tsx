...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-[#EFDFCC] bg-opacity-80 text-[#66796B] overflow-hidden" onWheel={handleWheel}>
      ...
      <div className="fixed bottom-10 left-1/2 transform -translate-x-1/2 z-50 flex flex-col items-center">
        {activeSlide < totalSlides && (
          <motion.button
            ...
            className="p-2 rounded-full bg-[#BA8E7A] text-white mb-2"
          >
            <ChevronDown size={24} />
          </motion.button>
        )}
      ...
      <div className="relative w-full">
        ...
        <Slide6 isActive={activeSlide === 8} />
        <Slide7 isActive={activeSlide === 10} />
        <Slide8 isActive={activeSlide === 6} />
        <Slide9 isActive={activeSlide === 7} />
        <Slide10 isActive={activeSlide === 9} />
